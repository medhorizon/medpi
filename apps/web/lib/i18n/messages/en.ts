...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "meeting.loading": "Loading group meeting…",
    "meeting.notStarted": "Start a group meeting to open the six agent panes.",
    "meeting.desktopOnly": "Group meetings are available on desktop",
    "meeting.desktopOnlyDetail": "Use a wider window to view all six independent conversations.",
    "meeting.sixAgentGrid": "Six-agent group meeting",
    "meeting.waitingForPi": "Waiting for PI orchestration",
    "meeting.modelUnavailable": "model unavailable",
    "meeting.sessionUnavailable": "Session unavailable",
    "meeting.memberCreating": "Creating this agent session…",
    "meeting.configTitle": "Role model settings",
    "meeting.configDetail": "Choose the model and reasoning level used by each of the six current sessions.",
    "meeting.configModelFor": "Model for {role}",
    "meeting.configThinkingFor": "Reasoning level for {role}",
    "meeting.configSelectThinking": "Select a reasoning level",
    "meeting.configApply": "Apply to meeting",
    "meeting.configApplying": "Applying…",
    "meeting.configSaved": "Settings applied",
    "meeting.status.creating": "creating",
    "meeting.status.loading": "loading",
    "meeting.status.idle": "ready",
    "meeting.status.running": "running",
    "meeting.status.error": "error",
    "meeting.status.failed": "failed",
    "meeting.workflowLoading": "Loading lab workflow…",
    "meeting.workflowSummary": "{status} · {activeThreads} undergraduate threads active · {awaitingReview} parent tasks awaiting review · {blocked} blocked",
    "meeting.workflowOther": "Other (optional)",
    "meeting.workflowAnswered": "Submitted",
    "meeting.workflowSubmitting": "Submitting…",
    "meeting.workflowSubmit": "Submit answer",
    "meeting.workflowWaitingPackage": "Waiting for this doctor work package.",
    "meeting.workflowMode": "Mode",
    "meeting.workflowStage": "Stage",
    "meeting.workflowPreJudgment": "Pre-judgment",
    "meeting.workflowMasterReservation": "Master reservation",
    "meeting.workflowSynthesis": "Synthesis",
    "meeting.workflowSubmitted": "submitted",
    "meeting.workflowPending": "pending",
    "meeting.workflowNotReserved": "not reserved",
    "meeting.workflowAnalysis": "Analysis requests",
    "meeting.workflowNoAnalysisRequest": "No analysis request.",
    "meeting.workflowThreadCapacity": "Meeting thread capacity",
    "meeting.workflowNoUndergradTask": "No undergraduate parent task.",
    "meeting.workflowAttempt": "attempt",
    "meeting.workflowTaskThreads": "Task threads",
    "meeting.workflowRecordsOnly": "Bibliographic records only",
    "meeting.workflowNoClarifications": "No clarification cards yet.",
