...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "meeting.loading": "正在加载组会…",
    "meeting.notStarted": "启动组会后将在此打开六个智能体窗口。",
    "meeting.desktopOnly": "组会仅支持桌面端",
    "meeting.desktopOnlyDetail": "请使用更宽的窗口查看六个独立对话。",
    "meeting.sixAgentGrid": "六智能体组会",
    "meeting.waitingForPi": "等待 PI 编排",
    "meeting.modelUnavailable": "模型不可用",
    "meeting.sessionUnavailable": "会话不可用",
    "meeting.memberCreating": "正在创建此智能体会话…",
    "meeting.configTitle": "角色模型配置",
    "meeting.configDetail": "为六位角色指定当前会话使用的模型和推理强度。",
    "meeting.configModelFor": "{role} 使用的模型",
    "meeting.configThinkingFor": "{role} 使用的推理强度",
    "meeting.configSelectThinking": "请选择推理强度",
    "meeting.configApply": "应用到组会",
    "meeting.configApplying": "正在应用…",
    "meeting.configSaved": "配置已应用",
    "meeting.status.creating": "创建中",
    "meeting.status.loading": "加载中",
    "meeting.status.idle": "就绪",
    "meeting.status.running": "运行中",
    "meeting.status.error": "错误",
    "meeting.status.failed": "失败",
    "meeting.workflowLoading": "正在加载实验室工作流…",
    "meeting.workflowSummary": "{status} · 本科活跃线程 {activeThreads} 条 · 待验收父任务 {awaitingReview} 个 · 阻塞 {blocked} 个",
    "meeting.workflowOther": "其他（可选）",
    "meeting.workflowAnswered": "已提交",
    "meeting.workflowSubmitting": "提交中…",
    "meeting.workflowSubmit": "提交回答",
    "meeting.workflowWaitingPackage": "正在等待此博士工作包。",
    "meeting.workflowMode": "模式",
    "meeting.workflowStage": "阶段",
    "meeting.workflowPreJudgment": "预判断",
    "meeting.workflowMasterReservation": "硕士预留",
    "meeting.workflowSynthesis": "综合",
    "meeting.workflowSubmitted": "已提交",
    "meeting.workflowPending": "待处理",
    "meeting.workflowNotReserved": "未预留",
    "meeting.workflowAnalysis": "分析请求",
    "meeting.workflowNoAnalysisRequest": "暂无分析请求。",
    "meeting.workflowThreadCapacity": "会议线程容量",
    "meeting.workflowNoUndergradTask": "暂无本科父任务。",
    "meeting.workflowAttempt": "尝试",
    "meeting.workflowTaskThreads": "任务线程",
    "meeting.workflowRecordsOnly": "仅书目记录",
    "meeting.workflowNoClarifications": "暂无澄清选项卡。",
    "i18n.default": "默认",
    "i18n.disabled": "已禁用",
