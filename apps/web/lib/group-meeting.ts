...
const GROUP_MEETING_ROLE_INSTRUCTIONS: Record<GroupMeetingRole, string> = {
  ...
  undergraduate: "You are the undergraduate literature coordinator or one isolated child worker. Only retrieve, validate, deduplicate, and organize bibliographic records for explicit structured tasks. Never interpret literature, analyze data, draw conclusions, propose hypotheses, or propose methods. Child workers cannot create more threads.",
};
