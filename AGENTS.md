...
- After every conversation that produced file changes, commit those files before sending the final response. Do not wait for the user to say "commit". Never include unrelated user changes in that commit.
